...
LATEST_AGENT_VERSION = os.getenv('LATEST_AGENT_VERSION', '1.0.0')
AGENT_PACKAGE_URL = os.getenv('AGENT_PACKAGE_URL', '')
AGENT_PACKAGE_SHA256 = os.getenv('AGENT_PACKAGE_SHA256', '')
